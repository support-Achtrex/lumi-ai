  ...
  return (
    <div style={{ padding: '40px 48px', maxWidth: '1100px', margin: '0 auto', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
        <h1 style={{ fontSize: '28px', fontWeight: '700', m: 0 }}>Welcome, {user?.name?.split(' ')[0] || 'Godwin'}</h1>
        <button style={{ 
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
        <h2 style={{ fontSize: '18px', fontWeight: '600', margin: 0, display: 'flex', alignItems: 'center', gap: '8px' }}>
          Usage <span style={{ color: '#888', fontWeight: '400' }}>this month (May) <i className="ti ti-chevron-down" style={{ fontSize: '12px' }}/></span>
        </h2>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px', marginBottom: '40px' }}>
        ...
        <div style={{ background: '#FFF', border: '1px solid #EBEBEB', borderRadius: '16px', padding: '24px', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ fontSize: '32px', fontWeight: '700', marginBottom: '16px' }}>$9.72</div>
          <div style={{ display: 'flex', justifyContent: 'space-between', color: '#555', fontSize: '14px', marginTop: 'auto' }}>
            <span>Credits usage</span>
            <span style={{ fontWeight: '600', color: '#000' }}>$0.34</span>
          </div>
        </div>
        ...
        <div style={{ background: '#FFF', border: '1px solid #EBEBEB', borderRadius: '16px', padding: '24px', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ fontSize: '24px', fontWeight: '700', marginBottom: '16px' }}>174,246</div>
          <div style={{ marginTop: 'auto', display: 'flex', alignItems: 'flex-end', height: '40px', gap: '4px', borderBottom: '1px dashed #EBEBEB', paddingBottom: '4px' }}>
            {/* Mock chart bars */}
            <div style={{ width: '12%', height: '10%', background: '#000', borderRadius: '2px 2px 0 0' }}></div>
            <div style={{ width: '12%', height: '30%', background: '#000', borderRadius: '2px 2px 0 0' }}></div>
            <div style={{ width: '12%', height: '80%', background: '#000', borderRadius: '2px 2px 0 0' }}></div>
            <div style={{ width: '12%', height: '60%', background: '#000', borderRadius: '2px 2px 0 0' }}></div>
            <div style={{ width: '12%', height: '5%', background: '#000', borderRadius: '2px 2px 0 0' }}></div>
            <div style={{ width: '12%', height: '20%', background: '#000', borderRadius: '2px 2px 0 0', marginLeft: 'auto' }}></div>
            <div style={{ width: '12%', height: '15%', background: '#000', borderRadius: '2px 2px 0 0' }}></div>
          </div>
        </div>
        ...
        <div style={{ background: '#FFF', border: '1px solid #EBEBEB', borderRadius: '16px', padding: '24px', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ fontSize: '24px', fontWeight: '700', marginBottom: '16px' }}>244</div>
          <div style={{ marginTop: 'auto', display: 'flex', alignItems: 'flex-end', height: '40px', gap: '4px', borderBottom: '1px dashed #EBEBEB', paddingBottom: '4px' }}>
             {/* Mock chart bars */}
             <div style={{ width: '8%', height: '10%', background: '#000', borderRadius: '2px 2px 0 0', marginLeft: '50%' }}></div>
             <div style={{ width: '8%', height: '80%', background: '#000', borderRadius: '2px 2px 0 0' }}></div>
             <div style={{ width: '8%', height: '50%', background: '#000', borderRadius: '2px 2px 0 0' }}></div>
             <div style={{ width: '8%', height: '5%', background: '#000', borderRadius: '2px 2px 0 0' }}></div>
             <div style={{ width: '8%', height: '60%', background: '#000', borderRadius: '2px 2px 0 0', marginLeft: '10%' }}></div>
             <div style={{ width: '8%', height: '40%', background: '#000', borderRadius: '2px 2px 0 0' }}></div>
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px', marginBottom: '40px' }}>
        ...
        <div style={{ background: '#FFF', border: '1px solid #EBEBEB', borderRadius: '16px', padding: '24px', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            ...
            <span style={{ background: '#FFF0E5', color: '#E85D04', fontSize: '12px', padding: '2px 8px', borderRadius: '12px', fontWeight: '600' }}>Grok 4.3</span>
          </div>
      ...
      <div style={{ background: '#FFF', border: '1px solid #EBEBEB', borderRadius: '16px', padding: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <span style={{ fontWeight: '700', fontSize: '16px' }}>Grok <span style={{ color: '#888', fontWeight: '400' }}>Business</span></span>
          <div style={{ width: '1px', height: '24px', background: '#EBEBEB' }}></div>
          <span style={{ color: '#555', fontSize: '15px' }}>Subscribe to Grok for your team, get free API credits.</span>
        </div>
        <button style={{ background: '#000', color: '#FFF', border: 'none', padding: '10px 24px', borderRadius: '24px', fontWeight: '600', fontSize: '14px', cursor: 'pointer' }}>
          Learn more
        </button>
